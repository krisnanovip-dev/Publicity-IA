...
export const SparklesIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.293 2.293a1 1 0 01-1.414 1.414L12 6.414l-2.293 2.293a1 1 0 01-1.414-1.414L10 4.293m0 14.414l2.293-2.293a1 1 0 011.414 1.414L12 19.586l-2.293-2.293a1 1 0 011.414-1.414L10 17.707M17 3l-1.586 1.586a1 1 0 01-1.414 0l-1.586-1.586m4.586 14.586l-1.586-1.586a1 1 0 010-1.414l1.586-1.586m-4.586-2.586l-1.586 1.586a1 1 0 01-1.414 0l-1.586-1.586M17 11V7m0 4h4" />
  </svg>
);
